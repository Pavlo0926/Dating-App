...
const verifyChildrenProp = (children: string, textStyles: Object) => {
  if (typeof children !== "string" && children !== undefined && children !== null) {
    console.warn(
      `react-native-styled-text: children must a string, undefined or null (${JSON.stringify(
        children,
      )})`,
    );
    return false;
...
const verifyTextStylesProp = (textStyles: Object) => {
  if (typeof textStyles !== "object" && textStyles !== undefined && textStyles !== null) {
    console.warn(
      `react-native-styled-text: textStyles must an object, undefined or null (${JSON.stringify(
        textStyles,
      )})`,
    );
    return false;
